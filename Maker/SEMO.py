      ...
      try:
       if not i["bot_username"] in Done:
        ...
        try:
           ...
           pass
        try:
          await user.join_chat("M_F_lI")
        except:
          pass
        try:
          await user.join_chat("GRQaid")
        except:
          pass
        try:
          await user.join_chat("SO_Qaid")
        except:
          pass
